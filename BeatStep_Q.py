...
class BeatStep_Q(ControlSurface):
    ...
    def _send_midi(self, midi_event_bytes, optimized=True):
        self.log_message(
            str(midi_event_bytes)
            + "      ||      "
            + str(self.QS.decode(midi_event_bytes))
        )
        super(BeatStep_Q, self)._send_midi(midi_event_bytes, optimized)
    ...
    def _setup_hardware(self):
        self.log_message("start of hardware setup")
        self._init_color_sequence()
        self._setup_control_buttons_and_encoders()
        self.log_message("control buttons and encoders finished")
        self._setup_buttons_and_encoders()
        self.log_message("buttons and encoders finished")
        ...
        self.log_message("hardware setup finished")
